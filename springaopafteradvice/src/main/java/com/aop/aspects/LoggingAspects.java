...
public class LoggingAspects {
	...
	public void startMeth(JoinPoint jp)
	{
	  ...
	  //After Returning Advice (if any exception occured for respective methods it wont run
	  
	  @AfterReturning("getAllCircleMeths()") public void startMethAR(JoinPoint jp)
	  {
	  
	  System.out.println("Aspect one after method " + jp.toString()); }
	 //to handle exception and execute log method before it need to use after throwing
	  
	  @AfterThrowing("args(name)")
		public void startMethThrow(String name)
		{
			
			System.out.println("Aspect one after throwing method " + name);
		}
		
	  @AfterReturning(pointcut = "args(name)",returning = "return_val")
		public void startMethThrowRet(String name,String return_val)
		{
			
			System.out.println("Aspect one after throwing method " + name+"return val"+return_val);
		}
	...
	public void startMethArgs(String name)
	{
	 ...
	 @AfterThrowing(pointcut = "args(name)",throwing = "ex")
		public void startMethThrowObj(String name,Exception ex)
		{
